...
# 全局下载地址配置
DOCKER_COMPOSEV4_URL="https://github.com/aict666/flux-panel/releases/download/2.0.7-beta/docker-compose-v4.yml"
DOCKER_COMPOSEV6_URL="https://github.com/aict666/flux-panel/releases/download/2.0.7-beta/docker-compose-v6.yml"
